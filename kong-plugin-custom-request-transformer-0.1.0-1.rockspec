package = "kong-plugin-custom-request-transformer"  -- TODO: rename, must match the info in the filename of this rockspec!
...
local pluginName = "custom-request-transformer"
